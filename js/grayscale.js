$('#norma-button').on('click', function() { 
            if($(document.getElementById("norma")).hasClass('activate')) { 
...
$('#ray-button').on('click', function() { 
                if($(document.getElementById("ray")).hasClass('activate')) { 
                   document.getElementById("ray").classList.remove('activate');
            }    
else{
